...
public class CarteResidenceService {
    ...
    public CarteResidence creerCarteResidence(String refCarteResidence, LocalDate dateDebut, LocalDate dateFin,
            Demande demande) {
        try {
            ...
            throw new ValidationException("Le visa '" + refCarteResidence + "' existe déjà.");
        }
